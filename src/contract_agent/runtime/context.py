...
class WorkflowContext:
    ...
    def call_count(self, tool_name: str, resource_id: str | None = None) -> int:
        """Exposed to CEL: workflow.call_count(tool_name) or workflow.call_count(tool_name, correlation_id)."""
        if resource_id is None or resource_id == "":
